...
export function returnValuesWithPromise() {
  ...
  */
  var promise = new Promise(function (resolve, reject) {
    ...
    */
    console.log(1);
    // llamando al servidor si todo sale bien llamamos a resolve y si todo sale mal llamamos a reject
  ...
  return promise
    ...
    .then(function (value) {
      console.log('Valor exitoso', value)
      return value
    })
...
export function rejectValuesWithPromise() {
  ...
  */
  ...
  return promise
    ...
    //.then(function(value){
    //  console.log('Despues del catch', value.message);
    //  return value
    //})
    //.catch(function (error) {
